...
import { TenantMemberEmbed, TenantRepository } from '@server/repository';
import { BillingsRpcClientService, RolesRpcClientService, TenantCreatedEvent } from '@server/core';
...
import { CreateTenantResponse, Tenant } from '@server/proto-schema/tenant';
