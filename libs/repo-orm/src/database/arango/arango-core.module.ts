...
import { ARANGO_DATABASE_CONTAINER_NAME, ARANGO_DEFAULT_DATABASE_CONTAINER_NAME } from '../../constants';
...
export class ArangoCoreModule implements OnModuleDestroy {
    ...
    async onModuleDestroy() {
        const clientsMap: Map<any, Database> = this.moduleRef.get<Map<any, Database>>(getArangoContainerToken(this.containerName));
