...
import { DeleteMemberInput, InviteMemberInput, Member, MemberMutations, UpdateMemberInput } from './types';
import { GqlAuthGuard, GqlContext, Resource, setRpcContext } from '@server/core';
import { UseGuards } from '@nestjs/common';
import { Member as RpcMember } from '@server/proto-schema/tenant';
