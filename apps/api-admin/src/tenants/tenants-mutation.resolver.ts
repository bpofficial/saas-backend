...
import { CreateTenantInput, DeleteTenantInput, Tenant, TenantMutations, UpdateTenantInput } from './types';
import { GqlAuthGuard, GqlContext, Resource, setRpcContext } from '@server/core';
import { UseGuards } from '@nestjs/common';
import { CreateTenantRequest, Tenant as RpcTenant, UpdateTenantRequest } from '@server/proto-schema/tenant';
