...
import { AppUtils, authSetup, bloodTearsMiddleware, corsOptions, setupSwagger } from '@server/common';
import { SwaggerModule } from '@nestjs/swagger';
import { enableMultiTenancy, TenantDatabaseStrategy } from '@server/core/mutiltenancy';
