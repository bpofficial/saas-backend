...
} from '@server/proto-schema/tenant';
import { CreateTenantCommand, GetTenantQuery, GetTenantsQuery, RemoveTenantCommand, TenantAvailableQuery, UpdateTenantCommand } from './cqrs';
import { getIdentityFromCtx } from '@server/core';
