...
import { GqlAuthGuard, GqlContext, PermissionsInterceptor, Resource, setRpcContext } from '@server/core';
import { UseGuards, UseInterceptors } from '@nestjs/common';
import { User } from '../users/types';
import { Tenant as RpcTenant } from '@server/proto-schema/tenant';
import { User as RpcUser } from '@server/proto-schema/account';
