...
import { CreateWebhookInput, DeleteWebhookInput, UpdateWebhookInput, Webhook, WebhookMutations } from './types';
import { GqlAuthGuard, GqlContext, Resource, setRpcContext } from '@server/core';
import { UseGuards } from '@nestjs/common';
import { CreateWebhookRequest, UpdateWebhookRequest, Webhook as RpcWebhook } from '@server/proto-schema/webhook';
import { WebhookAuthEnum } from '@server/contracts';
