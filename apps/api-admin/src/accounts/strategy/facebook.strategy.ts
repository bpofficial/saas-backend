...
import { CreateRequest, LoginRequest, LoginServiceTypes } from '@server/proto-schema/account';
...
export class FacebookStrategy extends PassportStrategy(Strategy) {
    ...
    constructor(
        ...
        super({
            clientID: 'gfg',// config.get<string>('app.auth.strategies.facebook.clientID'),
